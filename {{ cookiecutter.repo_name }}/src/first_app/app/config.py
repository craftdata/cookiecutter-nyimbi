...
SQLALCHEMY_DATABASE_URI = 'postgresql://nyimbi:abcd1234@localhost/{{cookiecutter.db_name}}'
...
MAIL_USE_TLS = True
MAIL_USERNAME = '{{cookiecutter.project_name}}@gmail.com'
MAIL_PASSWORD = 'Abcd1234.'
MAIL_DEFAULT_SENDER = '{{cookiecutter.project_name}}@gmail.com'
